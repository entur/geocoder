...
class PhotonFilterBuilderTest {
    ...
    fun `buildIncludes creates filters for real Norwegian search scenarios`() {
        ...
        val scenarios = listOf(
            FilterScenario("Empty filters", null, emptyList(), emptyList(), emptyList(), emptyList(),
                          emptyList(), emptyList(), emptyList(), emptyList()),
            FilterScenario("Oslo only", "NOR", listOf("03"), emptyList(), emptyList(), emptyList(),
                          emptyList(), emptyList(), emptyList(),
                          listOf("country.NOR", "county_gid.03")),
            FilterScenario("Bergen addresses", "NOR", listOf("46"), listOf("4601"), emptyList(), emptyList(),
            ...
            FilterScenario("Trondheim transit", "NOR", listOf("50"), emptyList(),
                          listOf("ATB:TariffZone:A", "ATB:TariffZone:B"), listOf("ATB"),
                          listOf("osm"), listOf("venue"), listOf("transport"),
                          listOf("country.NOR", "county_gid.50", "tariff_zone_id.ATB:TariffZone:A", "tariff_zone_id.ATB:TariffZone:B",
                                "tariff_zone_authority.ATB", "legacy.source.osm", "legacy.layer.venue", "legacy.category.transport")),
            FilterScenario("NO_FILTER bypass", null, emptyList(), emptyList(), emptyList(), emptyList(),
