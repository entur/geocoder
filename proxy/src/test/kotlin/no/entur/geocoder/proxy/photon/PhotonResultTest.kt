...
class PhotonResultTest {
    ...
    fun `parse creates PhotonResult from valid JSON`() {
                ...
                "features": [
                    {
                        ...
                        "properties": {
                            ...
                            "osm_value": "station",
                            "extra": {
                                "id": "OSM:TopographicPlace:123456789",
                                "source": "osm",
                                "locality": "Oslo",
                                "locality_gid": "0301",
                                "county_gid": "03",
        ...
        assertEquals("OSM:TopographicPlace:123456789", props.extra.id)
                ...
                "features": [
                    {
                        ...
                        "properties": {
                            "name": "Place 1",
                            "extra": {"id": "OSM:TopographicPlace:1"}
                        }
                    },
                    {
                        "geometry": {
                        ...
                        "properties": {
                            "name": "Place 2",
                            "extra": {"id": "OSM:TopographicPlace:2"}
                        }
                    },
                    {
                        "geometry": {
                        ...
                        "properties": {
                            "name": "Place 3",
                            "extra": {"id": "OSM:TopographicPlace:3"}
                        }
                    }
                ]
            }
                ...
                "features": [
                    {
                        ...
                        "properties": {
                            ...
                            "countrycode": "NO",
                            "type": "house",
                            "extra": {"id": "OSM:TopographicPlace:123456789"}
                        }
                    }
                ]
            }
