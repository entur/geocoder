...
class ProxyTest {
    ...
    @Test
    fun `test autocomplete endpoint`() = testApplication {
        ...
        val response = client.get("/v1/autocomplete") {
    ...
    @Test
    fun `test reverse endpoint`() = testApplication {
        val mockEngine = MockEngine { request ->
        ...
        val response = client.get("/v1/reverse") {
